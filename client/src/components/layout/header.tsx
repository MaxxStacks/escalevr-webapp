    ...
    <header className="bg-white dark:bg-gray-800 shadow-sm z-10 border-b border-border">
      <div className="px-4 py-3 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center md:hidden">
          <Button variant="ghost" size="icon" onClick={() => setShowMobileMenu(true)} className="text-muted-foreground hover:text-foreground">
            ...
            <SheetContent side="left" className="w-[280px]">
              <div className="flex flex-col h-full py-6">
                ...
                <div className="pt-4 border-t border-border">
                  <Button 
                    variant="ghost" 
                    className="flex items-center w-full justify-start text-foreground hover:text-primary"
